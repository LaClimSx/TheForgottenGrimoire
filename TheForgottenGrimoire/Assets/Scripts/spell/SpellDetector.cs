...
{       
    ...
    /// </param>
    public void DetectSpell(List<Vector3> listPoints, Vector3 headSetPosition, Action<SpellShape, double> onDetect)
    {
        ...
        onDetect?.Invoke((SpellShape)idxMinError, softmaxInvMinError);
    }
